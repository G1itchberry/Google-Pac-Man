...
function () {
  var a = true,
    ...
    {
      ghostSpeed: 1.05,
      ghostTunnelSpeed: 0.55,
      playerSpeed: 1.1,
      dotEatingSpeed: 0.95,
      ghostFrightSpeed: 0.65,
      playerFrightSpeed: 1.1,
      dotEatingFrightSpeed: 0.95,
      elroyDotsLeftPart1: 50,
      elroySpeedPart1: 1.1,
      elroyDotsLeftPart2: 25,
      elroySpeedPart2: 1.15,
      frightTime: 2,
      frightBlinkCount: 5,
      fruit: 3,
      fruitScore: 500,
    ...
    {
      ghostSpeed: 1.15,
      ghostTunnelSpeed: 0.6,
      playerSpeed: 1.2,
      dotEatingSpeed: 1.03,
      ghostFrightSpeed: 0.7,
      playerFrightSpeed: 1.2,
      dotEatingFrightSpeed: 1.03,
      elroyDotsLeftPart1: 60,
      elroySpeedPart1: 1.2,
      elroyDotsLeftPart2: 30,
      elroySpeedPart2: 1.25,
      frightTime: 2,
      frightBlinkCount: 5,
      fruit: 4,
      fruitScore: 700,
      fruitFrightBonus: 1,
      ghostModeSwitchTimes: [3, 20, 3, 20, 5, 1037, 1 / 60, 1],
      penForceTime: 3,
      penLeavingLimits: [0, 0, 0, 0],
      cutsceneId: 2
    },
    ...
    },
    {
      ...
      fruitScore: 2E3,
      fruitFrightBonus: 1,
      ghostModeSwitchTimes: [1, 20, 1, 20, 3, 1039, 1 / 30, 1],
      penForceTime: 3,
      penLeavingLimits: [0, 0, 0, 0],
      cutsceneId: 3
    },
    ...
    {
      ghostSpeed: 1.25,
      ghostTunnelSpeed: 0.65,
      playerSpeed: 1.3,
      dotEatingSpeed: 1.11,
      ghostFrightSpeed: 0.75,
      playerFrightSpeed: 1.3,
      dotEatingFrightSpeed: 1.11,
      elroyDotsLeftPart1: 100,
      elroySpeedPart1: 1.3,
      elroyDotsLeftPart2: 50,
      elroySpeedPart2: 1.35,
      frightTime: 1,
      frightBlinkCount: 3,
      fruit: 8,
      fruitScore: 5E3,
    ...
    },
    {
      ...
      playerFrightSpeed: 1.3,
      dotEatingFrightSpeed: 1.11,
      elroyDotsLeftPart1: 160,
      elroySpeedPart1: 1.3,
      elroyDotsLeftPart2: 80,
      elroySpeedPart2: 1.35,
      frightTime: 0,
      frightBlinkCount: 0,
      fruit: 8,
    ...
    {
      ghostSpeed: 1.35,
      ghostTunnelSpeed: 0.7,
      playerSpeed: 1.4,
      dotEatingSpeed: 1.19,
      ghostFrightSpeed: 0.8,
      playerFrightSpeed: 1.4,
      dotEatingFrightSpeed: 1.19,
      elroyDotsLeftPart1: 200,
      elroySpeedPart1: 1.4,
      elroyDotsLeftPart2: 100,
      elroySpeedPart2: 1.45,
      frightTime: 0,
      frightBlinkCount: 0,
      fruit: 8,
      fruitScore: 5E3,
  ...
  E.prototype.d = function () {
    ...
    if (!this.ghost && g.speedBoost && g.speedBoost[this.id]) {
      b *= g.speedBoostMultiplier;
    }
  ...
  g.updatePlayerSpeedBoost = function () {
  ...
  E.prototype.s = function () {
    ...
    if (g.gameplayMode == 1 && this.id == g.playerEatingGhostId) {
      ...
      if (this.id == 0) {
        // Pac-Man uses the closed-mouth frame for every direction.
        if (b == 3) b = 2
      } else {
        // Keep the original ghost animation behavior unchanged.
  ...
  E.prototype.r = function () {
    ...
    } else if ((this.mode == 4 && this.id != g.invulnerableGhostId) || (this.mode == 16 || this.mode == 32) && g.mainGhostMode == 4 && !this.eatenInThisFrightMode) {
      b = 0;
      c = 8;
  ...
  g.createPlayfield = function () {
    ...
    g.pauseEl = document.createElement("div");
    g.pauseEl.id = "pcm-paused";
    g.pauseEl.style.display = "none";
    g.prepareElement(g.pauseEl, 171, 105);
    g.canvasEl.appendChild(g.pauseEl);
  };
...
g.showPause = function () {
  if (g.pauseEl) g.pauseEl.style.display = "block";
};

g.hidePause = function () {
  if (g.pauseEl) g.pauseEl.style.display = "none";
};
g.togglePause = function () {
  if (g.gameplayMode != 0) return;
  ...
  g.handleKeyUp = function (b) {
    if (!b) b = window.event;

    if (b.code == "ControlRight") {
      g.speedBoost[0] = e;
      g.updatePlayerSpeedBoost();
      return;
    }
  ...
  g.addEventListeners = function () {
    if (window.addEventListener) {
      ...
      window.addEventListener("keyup", g.handleKeyUp, e);
  ...
  g.dotEaten = function (b, c) {
    ...
    if (g.playfield[c[0]][c[1]].dot == 2) {
      ...
      var hideMaze = Math.random() < 0.40;

      var makeGhostInvulnerable = Math.random() < 0.40;

      g.switchMainGhostMode(4, e);

      if (makeGhostInvulnerable) {
        g.invulnerableGhostId =
          g.playerCount + Math.floor(Math.random() * 4);

        var f = g.actors[g.invulnerableGhostId];
        if (f.mode == 4) f.a(g.lastMainGhostMode);
      }

      g.setMazeVisible(!hideMaze);
  ...
  g.hideFruit = function () {
    g.fruitShown = e;
    g.changeElementBkPos(g.fruitEl, 999, 16, a)
  };
  ...
  g.eatFruit = function (b) {
    if (g.fruitShown) {
      ...
      var d = g.levels.frightTime;
      g.levels.frightTime += g.levels.fruitFrightBonus;
      g.switchMainGhostMode(4, e);
      g.frightModeTime += g.levels.fruitFrightBonus * d;
      g.invulnerableGhostId = -1;
      g.levels.frightTime = d;

      g.modeScoreMultiplier = 2;
      g.setGhostVisible(false);
    }
  };
  ...
  g.ghostDies = function (b, c) {
    ...
    g.actors[b].el.style.visibility = "visible";
  ...
  g.detectCollisions = function () {
    g.tilesChanged = e;
    for (var b = g.playerCount; b < g.playerCount + 4; b++) for (var c = 0; c < g.playerCount; c++) if (g.actors[b].tilePos[0] == g.actors[c].tilePos[0] && g.actors[b].tilePos[1] == g.actors[c].tilePos[1]) if (g.actors[b].mode == 4 && b != g.invulnerableGhostId) {
      g.ghostDies(b, c);
      return
  ...
  g.finishLevel = function () {
    g.setGhostVisible(true);
    g.setMazeVisible(true);
...
g.toggleSpeedBoost = function () {
  if (g.gameplayMode != 0) return;

  g.speedBoost = !g.speedBoost;

  g.currentPlayerSpeed =
    g.levels.playerSpeed * 0.8 *
    (g.speedBoost ? g.speedBoostMultiplier : 1);

  g.currentDotEatingSpeed =
    g.levels.dotEatingSpeed * 0.8 *
    (g.speedBoost ? g.speedBoostMultiplier : 1);

  for (var b = 0; b < g.playerCount; b++) {
    g.actors[b].fullSpeed = g.currentPlayerSpeed;
    g.actors[b].dotEatingSpeed = g.currentDotEatingSpeed;
    g.actors[b].tunnelSpeed = g.currentPlayerSpeed;
    g.actors[b].d();
  }

  g.updateSpeedBoostButton();
};
  ...
  g.setMazeVisible = function (visible) {
  if (!g.playfieldEl) return;

  if (g.useCss) {
    if (visible) {
      g.playfieldEl.style.backgroundImage =
        "url(src/pacman10-hp-sprite-2.png)";
      g.playfieldEl.style.backgroundRepeat = "no-repeat";

      g.changeElementBkPos(g.playfieldEl, 256, 0, true);
    } else {
      g.playfieldEl.style.backgroundImage = "none";
    }

  } else if (g.playfieldEl.childNodes[0]) {
    g.playfieldEl.childNodes[0].style.visibility =
...
g.setGhostVisible = function (visible) {
  for (var b = g.playerCount; b < g.playerCount + 4; b++) {
    if (g.actors[b] && g.actors[b].ghost) {
      g.actors[b].el.style.visibility = visible ? "visible" : "hidden";
    }
  }
};
g.setGameplayVisible = function(visible) {
  for (var b = 0; b < g.actors.length; b++) {
    if (g.actors[b] && g.actors[b].el) {
      g.actors[b].el.style.visibility = visible ? "visible" : "hidden";
    }
  }
};
  ...
  g.handleGhostModeTimer = function () {
    if (g.frightModeTime) {
      g.frightModeTime--;
      if (g.frightModeTime <= g.timing[4])
          g.setGhostVisible(true);
  ...
  /*
   * HTML5 replacement for the original Flash SoundPlayer.
   */
  g.soundFiles = {
    "eating-dot-2": "src/swf/pacman10-source/sounds/1_com.google.pacman.SoundPlayer_eatingDotTwoClass_com.google.pacman.SoundPlayer_eatingDotTwoClass.mp3",
    "ambient-1": "src/swf/pacman10-source/sounds/2_com.google.pacman.SoundPlayer_ambientOneClass_com.google.pacman.SoundPlayer_ambientOneClass.mp3",
    "death-double": "src/swf/pacman10-source/sounds/3_com.google.pacman.SoundPlayer_deathDoubleClass_com.google.pacman.SoundPlayer_deathDoubleClass.mp3",
    "fruit": "src/swf/pacman10-source/sounds/4_com.google.pacman.SoundPlayer_fruitClass_com.google.pacman.SoundPlayer_fruitClass.mp3",
    "eating-dot-1": "src/swf/pacman10-source/sounds/5_com.google.pacman.SoundPlayer_eatingDotOneClass_com.google.pacman.SoundPlayer_eatingDotOneClass.mp3",
    "death": "src/swf/pacman10-source/sounds/6_com.google.pacman.SoundPlayer_deathClass_com.google.pacman.SoundPlayer_deathClass.mp3",
    "ambient-3": "src/swf/pacman10-source/sounds/7_com.google.pacman.SoundPlayer_ambientThreeClass_com.google.pacman.SoundPlayer_ambientThreeClass.mp3",
    "ambient-fright": "src/swf/pacman10-source/sounds/8_com.google.pacman.SoundPlayer_ambientFrightClass_com.google.pacman.SoundPlayer_ambientFrightClass.mp3",
    "ambient-eyes": "src/swf/pacman10-source/sounds/9_com.google.pacman.SoundPlayer_ambientEyesClass_com.google.pacman.SoundPlayer_ambientEyesClass.mp3",
    "ambient-2": "src/swf/pacman10-source/sounds/10_com.google.pacman.SoundPlayer_ambientTwoClass_com.google.pacman.SoundPlayer_ambientTwoClass.mp3",
    "extra-life": "src/swf/pacman10-source/sounds/11_com.google.pacman.SoundPlayer_extraLifeClass_com.google.pacman.SoundPlayer_extraLifeClass.mp3",
    "start-music-double": "src/swf/pacman10-source/sounds/12_com.google.pacman.SoundPlayer_startMusicDoubleClass_com.google.pacman.SoundPlayer_startMusicDoubleClass.mp3",
    "eating-dot-double": "src/swf/pacman10-source/sounds/13_com.google.pacman.SoundPlayer_eatingDotDoubleClass_com.google.pacman.SoundPlayer_eatingDotDoubleClass.mp3",
    "start-music": "src/swf/pacman10-source/sounds/14_com.google.pacman.SoundPlayer_startMusicClass_com.google.pacman.SoundPlayer_startMusicClass.mp3",
    "eating-ghost": "src/swf/pacman10-source/sounds/15_com.google.pacman.SoundPlayer_eatingGhostClass_com.google.pacman.SoundPlayer_eatingGhostClass.mp3",
    "ambient-4": "src/swf/pacman10-source/sounds/16_com.google.pacman.SoundPlayer_ambientFourClass_com.google.pacman.SoundPlayer_ambientFourClass.mp3",
    "cutscene": "src/swf/pacman10-source/sounds/17_com.google.pacman.SoundPlayer_cutSceneClass_com.google.pacman.SoundPlayer_cutSceneClass.mp3"
  };

  g.soundChannels = {};
  g.ambientAudio = null;
  g.ambientTrackIntervalId = null;
  g.ambientChannelName = "";
  g.currentAmbientSoundName = "";

  g.makeSoundAudio = function (b) {
    var c = g.soundFiles[b];
    if (!c) return null;
    var d = new Audio(c);
    d.preload = "auto";
    return d
  ...
  g.playSound = function (b, c, d) {
    if (!(!g.soundAvailable || !google.pacManSound || g.paused)) {
      if (!d) g.stopSoundChannel(c);
      var f = g.makeSoundAudio(b);
      if (!f) return;
      try {
        var h = String(c);
        if (!g.soundChannels[h]) g.soundChannels[h] = [];
        g.soundChannels[h].push(f);
        f.addEventListener("ended", function () {
          if (g.soundChannels[h]) {
            g.soundChannels[h] = g.soundChannels[h].filter(function (x) {
              return x !== f
            })
          }
        });
  ...
  g.stopAllAudio = function () {
    if (!g.soundAvailable) return;
    if (g.ambientTrackIntervalId != null) {
      window.clearInterval(g.ambientTrackIntervalId);
      g.ambientTrackIntervalId = null
    }
    g.stopSoundChannel("ambient-1");
    g.stopSoundChannel("ambient-2");
    g.ambientChannelName = "";
    g.currentAmbientSoundName = "";
    g.ambientAudio = null;
  ...
  /*
   * Reproduce the original Flash SoundPlayer's ambient timing.
   * The MP3 files contain more audio than the loop interval used by
   * the SWF. The SWF restarted the sound before its natural end and
   * alternated two channels to make the loop continuous. HTML5
   * Audio.loop does NOT reproduce that behavior, so we do it here.
   */
  g.ambientLoopTimes = {
    "ambient-1": 381,
    "ambient-2": 327,
  ...
  g.repeatAmbientTrack = function () {
    if (!g.soundAvailable || !google.pacManSound || !g.currentAmbientSoundName) return;

    g.ambientChannelName = g.ambientChannelName == "ambient-1" ? "ambient-2" : "ambient-1";
    g.playSound(g.currentAmbientSoundName, g.ambientChannelName, false);
  };
  ...
  g.playAmbientSound = function () {
    if (g.soundAvailable && google.pacManSound) {
      ...
      if (!b) return;
      if (g.currentAmbientSoundName == b && g.ambientChannelName) return;
      ...
      g.currentAmbientSoundName = b;
      g.ambientChannelName = "ambient-1";
      g.playSound(b, g.ambientChannelName, false);

      var c = g.ambientLoopTimes[b];
      if (c) {
        /*
         * The original SWF used (loop time - 30ms) for setInterval.
         * Keep that exact 30ms lead-in behavior.
         */
        g.ambientTrackIntervalId = window.setInterval(g.repeatAmbientTrack, c - 30);
      }
    }
  };
  ...
  g.prepareSound = function () {
    g.soundAvailable = a;
    g.soundReady = a;
    if (typeof google.pacManSound == "undefined") google.pacManSound = a;
